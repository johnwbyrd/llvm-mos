...
; CHECK-NEXT:    buffer_store_dword v63, off, s[0:3], s32 offset:1068 ; 4-byte Folded Spill
...
; CHECK-NEXT:    v_accvgpr_write_b32 a28, v23
...
; CHECK-NEXT:    buffer_load_dword a7, off, s[0:3], s32 offset:372
...
; CHECK-NEXT:    buffer_store_dword v26, off, s[0:3], s32 offset:1056 ; 4-byte Folded Spill
; CHECK-NEXT:    s_nop 0
; CHECK-NEXT:    buffer_store_dword v27, off, s[0:3], s32 offset:1060 ; 4-byte Folded Spill
; CHECK-NEXT:    v_mov_b32_e32 v32, v25
; CHECK-NEXT:    buffer_store_dword v32, off, s[0:3], s32 offset:1048 ; 4-byte Folded Spill
; CHECK-NEXT:    s_nop 0
; CHECK-NEXT:    buffer_store_dword v33, off, s[0:3], s32 offset:1052 ; 4-byte Folded Spill
...
; CHECK-NEXT:    buffer_load_ushort v39, off, s[0:3], s32 offset:88
; CHECK-NEXT:    buffer_load_ushort v25, off, s[0:3], s32 offset:84
; CHECK-NEXT:    buffer_load_ushort v38, off, s[0:3], s32 offset:80
; CHECK-NEXT:    buffer_load_ushort v23, off, s[0:3], s32 offset:76
...
; CHECK-NEXT:    v_and_b32_e32 v33, 1, v48
...
; CHECK-NEXT:    v_and_b32_e32 v32, 1, v39
...
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[20:21], 1, v32
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[26:27], 1, v25
; CHECK-NEXT:    v_and_b32_e32 v25, 1, v38
...
; CHECK-NEXT:    buffer_load_dword a56, off, s[0:3], s32 offset:388
...
; CHECK-NEXT:    s_waitcnt vmcnt(2)
; CHECK-NEXT:    buffer_store_dword v6, off, s[0:3], s32 offset:996 ; 4-byte Folded Spill
...
; CHECK-NEXT:    buffer_load_dword v2, off, s[0:3], s32 offset:292
; CHECK-NEXT:    s_waitcnt vmcnt(2)
...
; CHECK-NEXT:    buffer_load_dword a13, off, s[0:3], s32 offset:256
...
; CHECK-NEXT:    buffer_load_dword v55, off, s[0:3], s32 offset:236
; CHECK-NEXT:    buffer_load_dword a9, off, s[0:3], s32 offset:232
; CHECK-NEXT:    buffer_load_dword a33, off, s[0:3], s32 offset:228
; CHECK-NEXT:    buffer_load_dword a38, off, s[0:3], s32 offset:224
; CHECK-NEXT:    buffer_load_dword a39, off, s[0:3], s32 offset:220
; CHECK-NEXT:    buffer_load_dword a36, off, s[0:3], s32 offset:216
; CHECK-NEXT:    buffer_load_dword a37, off, s[0:3], s32 offset:212
; CHECK-NEXT:    buffer_load_dword a42, off, s[0:3], s32 offset:208
; CHECK-NEXT:    buffer_load_dword a43, off, s[0:3], s32 offset:204
; CHECK-NEXT:    buffer_load_dword a40, off, s[0:3], s32 offset:200
; CHECK-NEXT:    buffer_load_dword a41, off, s[0:3], s32 offset:196
; CHECK-NEXT:    buffer_load_dword a49, off, s[0:3], s32 offset:192
; CHECK-NEXT:    buffer_load_dword a51, off, s[0:3], s32 offset:188
; CHECK-NEXT:    buffer_load_dword a45, off, s[0:3], s32 offset:184
; CHECK-NEXT:    buffer_load_dword a47, off, s[0:3], s32 offset:180
; CHECK-NEXT:    buffer_load_dword a54, off, s[0:3], s32 offset:176
; CHECK-NEXT:    buffer_load_dword a55, off, s[0:3], s32 offset:172
; CHECK-NEXT:    buffer_load_dword a52, off, s[0:3], s32 offset:168
; CHECK-NEXT:    buffer_load_dword a53, off, s[0:3], s32 offset:164
; CHECK-NEXT:    buffer_load_dword a57, off, s[0:3], s32 offset:160
; CHECK-NEXT:    buffer_load_dword a59, off, s[0:3], s32 offset:156
; CHECK-NEXT:    buffer_load_dword a58, off, s[0:3], s32 offset:152
; CHECK-NEXT:    buffer_load_dword a61, off, s[0:3], s32 offset:148
; CHECK-NEXT:    buffer_load_dword a62, off, s[0:3], s32 offset:144
; CHECK-NEXT:    buffer_load_dword a63, off, s[0:3], s32 offset:140
; CHECK-NEXT:    buffer_load_dword v53, off, s[0:3], s32 offset:712
...
; CHECK-NEXT:    buffer_load_dword v23, off, s[0:3], s32 offset:548
; CHECK-NEXT:    buffer_load_dword v3, off, s[0:3], s32 offset:544
; CHECK-NEXT:    buffer_load_dword v41, off, s[0:3], s32 offset:540
...
; CHECK-NEXT:    buffer_load_dword a15, off, s[0:3], s32 offset:456
...
; CHECK-NEXT:    buffer_load_dword v54, off, s[0:3], s32 offset:708
...
; CHECK-NEXT:    buffer_load_dword v52, off, s[0:3], s32 offset:692
...
; CHECK-NEXT:    buffer_load_dword a30, off, s[0:3], s32 offset:448
; CHECK-NEXT:    buffer_load_dword a22, off, s[0:3], s32 offset:444
; CHECK-NEXT:    buffer_load_dword a20, off, s[0:3], s32 offset:440
; CHECK-NEXT:    buffer_load_dword a18, off, s[0:3], s32 offset:436
; CHECK-NEXT:    buffer_load_dword a16, off, s[0:3], s32 offset:432
; CHECK-NEXT:    buffer_load_dword a14, off, s[0:3], s32 offset:428
; CHECK-NEXT:    buffer_load_dword a12, off, s[0:3], s32 offset:424
; CHECK-NEXT:    buffer_load_dword a10, off, s[0:3], s32 offset:420
; CHECK-NEXT:    buffer_load_dword a8, off, s[0:3], s32 offset:416
; CHECK-NEXT:    buffer_load_dword a6, off, s[0:3], s32 offset:412
; CHECK-NEXT:    buffer_load_dword a60, off, s[0:3], s32 offset:408
...
; CHECK-NEXT:    buffer_load_dword v26, off, s[0:3], s32 offset:668
...
; CHECK-NEXT:    buffer_load_dword a19, off, s[0:3], s32 offset:284
; CHECK-NEXT:    s_nop 0
...
; CHECK-NEXT:    v_xor_b32_e32 v6, v54, v51
; CHECK-NEXT:    v_xor_b32_e32 v21, v53, v50
...
; CHECK-NEXT:    v_xor_b32_e32 v6, v52, v33
; CHECK-NEXT:    v_and_b32_e32 v7, 0x7fffffff, v2
...
; CHECK-NEXT:    v_xor_b32_e32 v60, v26, v41
; CHECK-NEXT:    v_and_b32_e32 v61, 0x7fffffff, v6
; CHECK-NEXT:    v_xor_b32_e32 v2, v2, v13
...
; CHECK-NEXT:    flat_store_dwordx2 v[50:51], v[10:11]
; CHECK-NEXT:    v_lshrrev_b64 v[10:11], 2, v[58:59]
...
; CHECK-NEXT:    flat_store_dwordx2 v[34:35], v[10:11] offset:16
; CHECK-NEXT:    v_mov_b32_e32 v10, v36
...
; CHECK-NEXT:    v_mov_b32_e32 v9, v27
...
; CHECK-NEXT:    buffer_load_dword v36, off, s[0:3], s32 offset:1048 ; 4-byte Folded Reload
; CHECK-NEXT:    buffer_load_dword v37, off, s[0:3], s32 offset:1052 ; 4-byte Folded Reload
; CHECK-NEXT:    buffer_load_dword v38, off, s[0:3], s32 offset:1056 ; 4-byte Folded Reload
; CHECK-NEXT:    buffer_load_dword v39, off, s[0:3], s32 offset:1060 ; 4-byte Folded Reload
...
; CHECK-NEXT:    buffer_load_dword v50, off, s[0:3], s32 offset:1000 ; 4-byte Folded Reload
; CHECK-NEXT:    buffer_load_dword v51, off, s[0:3], s32 offset:1004 ; 4-byte Folded Reload
...
; CHECK-NEXT:    v_accvgpr_read_b32 v33, a29
...
; CHECK-NEXT:    flat_load_dwordx2 v[32:33], v[0:1] offset:40
...
; CHECK-NEXT:    v_lshrrev_b64 v[4:5], 5, v[32:33]
; CHECK-NEXT:    v_or_b32_e32 v5, v5, v2
...
; CHECK-NEXT:    flat_store_short v[0:1], v2
; CHECK-NEXT:    v_add_co_u32_e32 v0, vcc, 0x78, v34
; CHECK-NEXT:    v_alignbit_b32 v2, v30, v53, 15
; CHECK-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v35, vcc
; CHECK-NEXT:    flat_store_dword v[0:1], v2
; CHECK-NEXT:    v_lshlrev_b32_e32 v0, 31, v14
; CHECK-NEXT:    v_and_b32_e32 v1, 0x7fffffff, v0
; CHECK-NEXT:    v_or_b32_e32 v5, v1, v0
; CHECK-NEXT:    v_mov_b32_e32 v1, v55
; CHECK-NEXT:    v_and_b32_e32 v55, 0x7fffffff, v28
; CHECK-NEXT:    v_lshlrev_b32_e32 v0, 17, v53
; CHECK-NEXT:    v_lshrrev_b64 v[12:13], 14, v[54:55]
; CHECK-NEXT:    v_mov_b32_e32 v3, v57
; CHECK-NEXT:    v_and_b32_e32 v57, 0x7fffffff, v26
; CHECK-NEXT:    v_or_b32_e32 v13, v13, v0
; CHECK-NEXT:    v_add_co_u32_e32 v0, vcc, 24, v34
; CHECK-NEXT:    v_lshlrev_b32_e32 v2, 18, v54
...
; CHECK-NEXT:    v_or_b32_e32 v11, v11, v2
; CHECK-NEXT:    v_and_b32_e32 v53, 0x7fffffff, v20
...
; CHECK-NEXT:    v_lshrrev_b64 v[12:13], 10, v[52:53]
; CHECK-NEXT:    v_mov_b32_e32 v3, v45
; CHECK-NEXT:    v_and_b32_e32 v45, 0x7fffffff, v18
; CHECK-NEXT:    v_or_b32_e32 v13, v13, v2
; CHECK-NEXT:    v_lshlrev_b32_e32 v2, 22, v52
...
; CHECK-NEXT:    v_and_b32_e32 v27, 0x7fffffff, v8
; CHECK-NEXT:    flat_store_dwordx2 v[0:1], v[6:7] offset:32
; CHECK-NEXT:    v_or_b32_e32 v11, v11, v2
; CHECK-NEXT:    v_lshlrev_b32_e32 v2, 27, v32
; CHECK-NEXT:    v_lshrrev_b64 v[6:7], 4, v[26:27]
; CHECK-NEXT:    flat_store_dwordx4 v[0:1], v[10:13] offset:16
; CHECK-NEXT:    v_or_b32_e32 v7, v7, v2
; CHECK-NEXT:    v_accvgpr_read_b32 v10, a4
; CHECK-NEXT:    v_and_b32_e32 v11, 0x7fffffff, v6
; CHECK-NEXT:    flat_store_dwordx2 v[34:35], v[6:7] offset:32
; CHECK-NEXT:    v_lshlrev_b32_e32 v2, 28, v26
...
; CHECK-NEXT:    v_accvgpr_read_b32 v4, a18
...
; CHECK-NEXT:    v_accvgpr_read_b32 v12, a8
...
; CHECK-NEXT:    ; implicit-def: $agpr62
...
; CHECK-NEXT:    v_accvgpr_read_b32 v15, a42
; CHECK-NEXT:    v_accvgpr_read_b32 v16, a43
; CHECK-NEXT:    v_accvgpr_read_b32 v2, a23
; CHECK-NEXT:    v_accvgpr_read_b32 v3, a35
; CHECK-NEXT:    v_accvgpr_read_b32 v6, a27
; CHECK-NEXT:    v_cndmask_b32_e64 v3, v3, v2, s[4:5]
...
; CHECK-NEXT:    v_cndmask_b32_e64 v6, v10, v6, s[6:7]
; CHECK-NEXT:    v_accvgpr_read_b32 v10, a38
; CHECK-NEXT:    v_accvgpr_read_b32 v12, a9
; CHECK-NEXT:    v_accvgpr_read_b32 v0, a13
; CHECK-NEXT:    v_cndmask_b32_e64 v5, v58, v4, s[8:9]
; CHECK-NEXT:    v_cndmask_b32_e64 v4, v59, v55, s[8:9]
...
; CHECK-NEXT:    v_accvgpr_read_b32 v16, a36
...
; CHECK-NEXT:    v_accvgpr_read_b32 v9, a40
; CHECK-NEXT:    s_waitcnt vmcnt(0)
...
; CHECK-NEXT:    v_accvgpr_read_b32 v9, a45
; CHECK-NEXT:    s_waitcnt vmcnt(0)
...
; CHECK-NEXT:    v_accvgpr_read_b32 v9, a57
; CHECK-NEXT:    v_cndmask_b32_e64 v27, v8, v9, s[26:27]
...
; CHECK-NEXT:    buffer_load_dword v8, off, s[0:3], s32 offset:1044 ; 4-byte Folded Reload
; CHECK-NEXT:    v_accvgpr_read_b32 v9, a53
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    v_cndmask_b32_e64 v28, v8, v9, s[20:21]
; CHECK-NEXT:    buffer_load_dword v8, off, s[0:3], s32 offset:1064 ; 4-byte Folded Reload
; CHECK-NEXT:    v_accvgpr_read_b32 v9, a58
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    v_cndmask_b32_e64 v33, v8, v9, s[24:25]
...
; CHECK-NEXT:    v_accvgpr_read_b32 v9, a62
...
; CHECK-NEXT:    s_or_saveexec_b64 s[4:5], -1
; CHECK-NEXT:    buffer_load_dword v63, off, s[0:3], s32 offset:1068 ; 4-byte Folded Reload
; CHECK-NEXT:    s_mov_b64 exec, s[4:5]
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
