...
bool MOSLegalizerInfo::legalizeIntrinsic(LegalizerHelper &Helper,
  ...
  case Intrinsic::modf: {
    ...
    // For G_INTRINSIC with 2 results: op0=result0, op1=result1, op2=intrinsic_id, op3=input
    ...
    if (!createLibcall(Builder, Libcall,
  ...
  // TODO: Intrinsic::sincospi - picolibc doesn't provide sincospi/sincospif
  }
  return false;
}
