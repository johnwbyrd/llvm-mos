...
enum Fixups {
  ...
  Addr24_Segment, // The bank 16-bits of a 24-bit address.
  Addr24_Segment_Low, // The low 8 bits of the bank of a 24-bit address.
  Addr24_Segment_High, // The high 8 bits of the bank of a 24-bit address.
